...
# by Mark McMahon
# available from
# http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/475148
...
if __name__ == '__main__':
    ...
    class FuzzyTestCase(unittest.TestCase):
        ...
        def testCreation_Dict(self):
            ...
            self.assertEqual(self.test_dict['Hiya'], fd['hiya'])
        ...
        def testContains(self):
            ...
            self.assertEqual(True, fd.__contains__('hiya'))

            self.assertEqual(True, fd.__contains__('test3'))

            self.assertEqual(True, fd.__contains__('hiy\xe4'))

            self.assertEqual(False, fd.__contains__('FuzzyWuzzy'))
        ...
        def testGetItem(self):
            ...
            self.assertEqual(1, fd2['FuzzyWuzzy'])
