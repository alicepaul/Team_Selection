...
class Allocation:
    ...
    def __init__(self, survey):
        ...
        t = [(stu.last, stu.first, stu) for stu in list(survey.students.values())]
        t.sort()
    ...
    def dump(self, survey):
        ...
        for proj in self.projects:
            ...
            for last, stu in t:
                ...
                print(stu.prefs[proj], end=' ')
                print(stu.entry2(conflicts), end=' ')

                print(skill_string(stu, survey.skills), end=' ')
                print()
...
class Survey(object):
    ...
    def parse(self, filename):
        ...
        for t in reader:
            ...
            prefs = dict(list(zip(self.projects, prefs)))
        ...
        for student in list(self.students.values()):
            for proj, pref in student.prefs.items():
    ...
    def fix_whiners(self):
        ...
        for stu in stus:
            if stu.maxpref < 5:
                ...
                for proj, pref in list(stu.prefs.items()):
                    if pref == stu.maxpref:
                        stu.prefs[proj] = 5
    ...
    def print_conflicts(self):
        ...
        t = [(stu.tally, stu) for stu in list(self.students.values())]
        t.sort(reverse=True)
    ...
    def print_roles(self):
        ...
        t = [(total, role) for role, total in d.items()]
        t.sort(reverse=True)
        for total, role in t:
            print(role, total)
        print('')
    ...
    def print_students(self):
        ...
        t = [(stu.last, stu.first, stu) for stu in list(self.students.values())]
        t.sort()
